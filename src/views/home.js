...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Admired Fair Gnat</title>
        <meta property="og:title" content="Admired Fair Gnat" />
      </Helmet>
      ...
      <div className="home-hero">
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">Welcome to Hagi</h1>
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Revolutionizing the way you manage your projects</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Powerful Features for JSON Output
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Experience the benefits of our advanced JSON generation
                      capabilities
                    </span>
                    <span>
                      <span
            ...
            <div className="home-container03">
              ...
              <FeatureCard
                heading="Feature 3"
                subHeading="Support for complex data structures in JSON output"
              ></FeatureCard>
              <FeatureCard
                heading="Feature 4"
                subHeading="Customizable JSON formatting options"
              ></FeatureCard>
            </div>
          </div>
        </div>
      ...
      <div className="home-pricing">
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <h2 className="heading2">Choose a Plan</h2>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Hagi is a powerful project management tool designed to
                  simplify your workflow and boost productivity. With its
                  intuitive interface and robust features, you can easily
                  collaborate with your team, track progress, and meet
                  deadlines.
                </span>
                <span>
                  <span
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="Hagi is a landing page template designed to help businesses create a visually appealing and effective online presence."
                question="What is hagi?"
              ></Question1>
              <Question1
                answer="Hagi can be used by any business or individual looking to showcase their products, services, or personal brand in a professional and engaging way."
                question="Who can use hagi?"
              ></Question1>
              <Question1
                answer="Yes, hagi is highly customizable. You can easily modify the colors, fonts, images, and content to match your brand identity and preferences."
                question="Is hagi customizable?"
              ></Question1>
              <Question1
                answer="Yes, hagi is fully responsive and optimized for mobile devices. Your landing page will look great on smartphones and tablets."
                question="Does hagi support mobile devices?"
              ></Question1>
              <Question1
                answer="Absolutely! Hagi supports seamless integration with popular tools and platforms such as email marketing services, CRM systems, and social media platforms."
                question="Can I integrate hagi with other tools and platforms?"
              ></Question1>
            </div>
          </div>
        </div>
